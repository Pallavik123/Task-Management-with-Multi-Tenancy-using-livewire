    ...
    <div class="card-controls sm:flex">
        <div class="w-full sm:w-1/2">
            ...
            @if(file_exists(app_path('Http/Livewire/ExcelExport.php')))
                <livewire:excel-export model="TaskStatus" format="csv" />
                <livewire:excel-export model="TaskStatus" format="xlsx" />
                <livewire:excel-export model="TaskStatus" format="pdf" />
            @endif


            @can('task_status_create')
                <x-csv-import route="{{ route('admin.task-statuses.csv.store') }}" />
            @endcan
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    ...
                                    @endcan
                                    @can('task_status_delete')
                                        <button class="btn btn-sm btn-rose mr-2" type="button" wire:click="confirm('delete', {{ $taskStatus->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
